...
run:
	${CABAL} run -- --height 124 --width 200 --scaling 4 --initial-sharks 0.01 --initial-fish 0.05 --initial-shark-energy 10 --fish-energy 4 --reproduce-shark 30 --reproduce-fish 10 --count-log wa-tor-counts-${TS}.tsv > wa-tor-${TS}.log
